...
app.get("/contact", (req, res) => {
  //renders contact.ejs file on "/contact" page
  res.render("contact", {
...
app.post("/compose", (req, res) => {
  //created an object for storing the title and text of the compose page 
  const composePost = {
    title: req.body.composeText,
    content: req.body.composePost
  };

  //pushed that object into an array having name 'posts'
